...
* [Agentlas OS](https://github.com/agentlas-ai/Agentlas-OS) ![](https://img.shields.io/github/stars/agentlas-ai/Agentlas-OS.svg?cacheSeconds=86400) - Agent Operation Environment for portable agent packages, multi-agent orchestration, runtime adapters, A2A Agent Cards, MCP integration, and verification gates.
