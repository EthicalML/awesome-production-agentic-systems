...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ![](https://img.shields.io/github/stars/Simon-He95/markstream-vue.svg?cacheSeconds=86400) - Markstream provides multi-framework streaming Markdown renderers for AI chat and agent interfaces across Vue, React, Svelte, Angular, and Vue 2, with Mermaid, KaTeX, syntax highlighting, safe HTML, and low-jitter updates.
