...
* [SandBase Harness](https://github.com/sandbaseai/sandbase-harness) ![](https://img.shields.io/github/stars/sandbaseai/sandbase-harness.svg?cacheSeconds=86400) - SandBase Harness is a self-hosted runtime for production agents with persistent sessions, MCP tool governance, memory, credentials, audit/replay, and Docker/Kubernetes sandbox providers.
