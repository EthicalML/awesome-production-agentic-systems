...
* [Bifrost](https://github.com/maximhq/bifrost) ![](https://img.shields.io/github/stars/maximhq/bifrost.svg?cacheSeconds=86400) - Bifrost is an AI gateway written in Go with a built-in MCP gateway, connecting LLMs to external MCP tools while providing routing, failover, and access control across 23+ providers.
