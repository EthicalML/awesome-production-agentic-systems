...
* [Agno](https://github.com/agno-agi/agno) ![](https://img.shields.io/github/stars/agno-agi/agno.svg?cacheSeconds=86400) - Agno is a full-stack framework for building multi-agent systems with memory, knowledge, and tools.
...
* [Mastra](https://github.com/mastra-ai/mastra) ![](https://img.shields.io/github/stars/mastra-ai/mastra.svg?cacheSeconds=86400) - Mastra is a TypeScript framework for building and shipping AI agents with workflows, memory, and observability.
...
* [Future AGI](https://github.com/future-agi/future-agi) ![](https://img.shields.io/github/stars/future-agi/future-agi.svg?cacheSeconds=86400) - Future AGI is an open-source self-hostable end-to-end agent engineering and optimization platform unifying tracing, evaluation, simulation, datasets, gateway, and guardrails in one feedback loop.
* [traceAI](https://github.com/future-agi/traceAI) ![](https://img.shields.io/github/stars/future-agi/traceAI.svg?cacheSeconds=86400) - traceAI is an open-source OpenTelemetry-native tracing library for LLM and agent apps. Auto-instruments 50+ frameworks across Python, TypeScript, Java, and C# (OpenAI, Anthropic, LangChain, LlamaIndex, CrewAI, Bedrock) with no vendor lock-in.
* [ai-evaluation](https://github.com/future-agi/ai-evaluation) ![](https://img.shields.io/github/stars/future-agi/ai-evaluation.svg?cacheSeconds=86400) - ai-evaluation is an open-source LLM evaluation framework with 50+ metrics, LLM-as-Judge augmentation, and guardrail scanners (jailbreak, PII, prompt-injection); AutoEval pipelines with CI/CD support.
* [agent-opt](https://github.com/future-agi/agent-opt) ![](https://img.shields.io/github/stars/future-agi/agent-opt.svg?cacheSeconds=86400) - agent-opt is an open-source library for evaluation-driven prompt and agent-workflow optimization with six algorithms (Random, Bayesian, ProTeGi, Meta-Prompt, PromptWizard, GEPA).
...
* [Inkog](https://github.com/inkog-io/inkog) ![](https://img.shields.io/github/stars/inkog-io/inkog.svg?cacheSeconds=86400) - Open-source AI agent security scanner. Detects prompt injection, infinite loops, token bombing, SQL injection via LLM, and missing human oversight across 20+ frameworks. CLI + MCP server with compliance mapping to EU AI Act, NIST AI RMF, and OWASP LLM Top 10.
